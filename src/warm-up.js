...
var vegetables = ["Squash, Peas, Corn, GreenBeans, Potatoes"]
// Write the code to access the 3rd element of the Array, using bracket
// notation.
console.log(vegetables[3]);
// Create a new variable "fruits" and assign it to an Array of 7
// different fruits.
var fruits = ["Strawberries, Pears, Bananas, Peaches, GrapeFruit, Apples, Oranges"];
...
var productsJSON = {
  ...
  selfLink:
    "https://www.googleapis.com/shopping/search/v1/public/products?country=US&q=digital+camera&alt=json",
  nextLink:
    "https://www.googleapis.com/shopping/search/v1/public/products?country=US&q=digital+camera&startIndex=26&alt=json",
  totalItems: 5788536,
  startIndex: 1,
  itemsPerPage: 25,
  currentItemCount: 25,
  ...
  items: [
    ...
    },
    {
      ...
      selfLink:
        "https://www.googleapis.com/shopping/search/v1/public/products?alt=json/1032628/gid/6306163093076466800",
      product: {
    ...
    },
    {
      ...
      selfLink:
        "https://www.googleapis.com/shopping/search/v1/public/products?alt=json/8688882/gid/18366881915581583933",
      product: {
        ...
        description:
          "Sony Alpha NEX-7 Digital Camera (Black, Body Only) - Sony Alpha NEX-7 Digital Camera (Black, Body Only)",
        link: "http://www.primotronix.com/tron/product_info.php?csv=gp&products_id=20666&zmam=80512835&zmas=2&zmac=1&zmap=20666",
        brand: "Sony",
        condition: "new",
        gtin: "00027242833838",
        gtins: ["00027242833838"],
        mpns: ["NEX7/B"],
        inventories: [
          {
            channel: "online",
    ...
    },
    {
      ...
      selfLink:
        "https://www.googleapis.com/shopping/search/v1/public/products?alt=json/123/gid/18146176324383458652",
      product: {
        ...
        language: "en",
        title:
          "Panasonic LUMIX DMC-FZ200 12.1 Megapixel Digital Camera - Black",
        description:
          "Panasonic's LUMIX FZ200 12.1 Megapixel Digital Camera features Amazing F2.8 Aperture Across Its Entire Zoom Range, Advanced MOS High Sensitivity Sensor, Full HD Video Recording At 60P and much more to help accommodate all your photo needs",
        link: "http://www.abesofmaine.com/item.do?item=PSDMCFZ200K&id=PSDMCFZ200K&l=ESEARCH_PLA",
        brand: "Panasonic",
        condition: "new",
        gtin: "00885170087804",
        gtins: ["00885170087804"],
        mpns: ["DMCFZ200K"],
        inventories: [
          {
            channel: "online",
    ...
    },
    {
      ...
      selfLink:
        "https://www.googleapis.com/shopping/search/v1/public/products?alt=json/6296724/gid/18145315413250138307",
      product: {
    ...
    },
    {
      ...
      selfLink:
        "https://www.googleapis.com/shopping/search/v1/public/products?alt=json/7867474/gid/18092316852173916770",
      product: {
    ...
    },
    {
      ...
      selfLink:
        "https://www.googleapis.com/shopping/search/v1/public/products?alt=json/9189052/gid/17912253870470323599",
      product: {
    ...
    },
    {
      ...
      selfLink:
        "https://www.googleapis.com/shopping/search/v1/public/products?alt=json/4257713/gid/17666264616508775253",
      product: {
        ...
        description:
          "Digital camera - 3D - compact - 10.0 Mpix - optical zoom: 3 x - suppor",
    ...
    },
    {
      ...
      selfLink:
        "https://www.googleapis.com/shopping/search/v1/public/products?alt=json/10009508/gid/17254992744481035890",
      product: {
        ...
        description:
          "Digital camera with support for interchangeable 1 NIKKOR lenses; Nikon 1 mount. NIKKOR 11-27.5mm f/3.5-5.6 retractable lens lets you shoot in wide or telephoto modes for crisp, sharp images",
    ...
    },
    {
      ...
      selfLink:
        "https://www.googleapis.com/shopping/search/v1/public/products?alt=json/6347724/gid/17225849483606303723",
      product: {
    ...
    },
    {
      ...
      selfLink:
        "https://www.googleapis.com/shopping/search/v1/public/products?alt=json/7937/gid/17171615172013541991",
      product: {
        ...
        language: "en",
        title:
          "Pentax MX-1 12-megapixel digital camera with 4X optical zoom (Silver)",
        description:
          "Pentax MX-1 12-megapixel digital camera with 4X optical zoom",
        link: "http://www.crutchfield.com/I-rgpscQUA/App/Product/Item/Default.aspx?I=815MX1S",
        brand: "Pentax",
        condition: "new",
        gtin: "00027075225299",
        gtins: ["00027075225299"],
        mpns: ["12633"],
        inventories: [
          {
            channel: "online",
    ...
    },
    {
      ...
      selfLink:
        "https://www.googleapis.com/shopping/search/v1/public/products?alt=json/9216392/gid/16960148472439603410",
      product: {
    ...
    },
    {
      ...
      selfLink:
        "https://www.googleapis.com/shopping/search/v1/public/products?alt=json/7827/gid/16569108489747966237",
      product: {
...
var totalBudget = productsJSON.items.product.author.budget;
console.log(budg)
